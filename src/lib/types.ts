...
export const HABIT_DEFINITIONS: Record<string, string[]> = {
  ...
  'Rajin Olahraga': [
    ...
    'Kedisiplinan Waktu',
    'Kualitas Pelaksanaan Olahraga',
    'Kepatuhan terhadap Aturan Olahraga',
    'Kemandirian dalam Berolahraga',
    'Penggunaan Alat dan Fasilitas Olahraga',
    'Pemilihan Olahraga yang Sesuai dengan Kondisi Fisik',
    'Sikap Positif dan Semangat',
  ],
  'Makan Sehat & Bergizi': [
    'Keteraturan Makan',
    'Pemilihan Makanan',
  ...
  'Tidur Cepat': [
    ...
    'Kualitas Tidur',
    'Menghindari aktivitas yang mengganggu kualitas tidur, seperti menonton TV atau menggunakan perangkat elektronik sebelum tidur.',
